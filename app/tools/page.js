...
function UserClaimableBalance() {
  ...
  if (claimableBalance >= 0) {
    ...
    return <div className="overlayContainer"><p>You need at least 10,000 WSKY available to claim to access the Tools. <br/><br/> Your current claimable balance is {claimableBalance} WSKY.</p>
