...
const Sidebar = () => {
    return (
            ...
            <div className='sidebarlinks'>
                ...
                <Link href="" className="navLink" disabled><span className='navText'>Promote </span><span className='emojiButton emoji'><Image alt="Promote" width="24" height="24" src="https://em-content.zobj.net/source/microsoft-teams/363/rocket_1f680.png" unoptimized/></span></Link>
            </div>
