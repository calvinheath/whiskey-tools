...
const Sidebar = () => {
    return (
            ...
            <div className='sidebarlinks'>
                ...
                <Link href="/tools" className="navLink"><span className='navText'>Tools </span><span className='emojiButton emoji'><Image alt="Promote" width="24" height="24" src="https://em-content.zobj.net/source/microsoft-teams/363/hammer-and-wrench_1f6e0-fe0f.png"/></span></Link>
